...
public:
    coreProcessor(char filtType = 1, char krnlRadius = 1, short **Input = NULL,
                  short **Output = NULL, int xLengthPreCalc_arg = 50, int yLengthPreCalc_arg = 50, int startFrame=0,
...
private:
    ...
    void startProcThread(short filtType ,short krnlRadius,
                                        short **Input,short **Output,int xLengthPreCalc,int yLengthPreCalc);
    ...
    void startParallelProcThread(short filtType ,short krnlRadius, short **Input,short **Output,int xLengthPreCalc,int yLengthPreCalc);
