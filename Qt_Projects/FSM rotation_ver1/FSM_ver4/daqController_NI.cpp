...
void daqController::configFetchThread()
{
  ...
  connect(scannerObj, SIGNAL(newArrival(qint32)), this, SLOT(newArrivalInDaq(qint32)));
  ...
  //else
      //WfmPtr = binaryWfm;
#if ACTUALSYSTEM
  scannerObj->setPars(vi,signalChannel,actualRecordLength, WfmPtr, wfmInfoPtr, daqInfoPtr->ScanPoints,
