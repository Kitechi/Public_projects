...
private slots:
    ...
    void on_pushButtonRotSetpos_released();
    void calcPossibleTrigPerRev();
    void calcScanPars(int trigsPerRevIndex = 0);
...
private:
    ...
    bool stopPressed;
    bool isHighRange;
    double posRotIntervalArr[100];
    double chosenRotInterval[NUMOFINTERVALS];
    double chosenTrigPerRev[NUMOFINTERVALS];
    int posRotIntervalArrSz;
    double rotInterval;
    double linInterval;
    double linSpeed;
