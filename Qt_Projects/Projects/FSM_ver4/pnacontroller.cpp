...
void pnaController::initN1500A()
{
    ...
    //connect(mainTimer, SIGNAL(timeout()), this, SLOT(doMeasureN1500A()));

    //calibration try
    //pITransLine->PerformGrlCal();
    //pITransLine->GetCalForGRL();
    //pITransLine->CalibrateProbeStd1();
    //pITransLine->MeasureGRLplate();
    //pITransLine->MeasureGRLempty();
    //pITransLine->ComputeGRL();
    //pITransLine->PerformGrlCal();
    //pITransLine->GetCalForGRL();
