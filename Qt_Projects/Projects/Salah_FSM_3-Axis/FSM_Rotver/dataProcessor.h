...
public:
    ...
    short filterItr2;
    unsigned int buffScanPoints;
    bool loadCoordinatesDone;

    //parameters calculation variables and arrays
    float Coordinates [100][2][100];
    float X [100][100];
    float Y [100][100];
    float XR [100][100];
    float YR [100][100];
    float referencePoint[100][100];

    float*** Interval;
    float Center_of_Rotation [2];
    float Chord_Mid [100][2][100];
    float Chord_Slope [100][100];
    float P_Bisector [100][100];
    float X_translator[100];
    float Y_translator[100];
    float special_Xo[100];
    float special_Yo[100];
    float special_Xn[100];
    float special_Yn[100];
    float Center[100][2][100];
    float Radius[100][100];
    int CentralValue_X;
    int CentralValue_Y;
    float Incident_Angle_R[100][100][100];
    float Incident_Angle_L[100][100][100];
    float Dot_product ;
    float Magnitude   ;
    float theta;
    float Total_IA       [100][100];
    float Average_IA     [100][100];
    float No_of_Values   [100][100];
    float Total_AOFR     [100][100];
    float Increment_Angle[100][100][100];
    float Final_IA_R     [100][100][100];
    float Increment_Angle_RF[100][100][100];
    float Final_IA_L     [100][100][100];
    float Increment_Linear[100][100][100];
    float Increment_Linear_F[100][100][100];
    float Final_IA     [100][100];
    float Extra_XCoor [100][100];
    float Extra_YCoor [100][100];
    float Arranged_XCoor [200][200];
    float Arranged_YCoor [200][200];
    float thetaR;
    int runtime = 0;
    //end
...
public slots:
    ...
    void loadCoordinates(bool status);
    ...
    float AngleCalc(float X, float Y, float CRX , float CRY, float CORX, float CORY);
...
signals:
    ...
    void loadDataDone();
    void CalcParametersDone();
    void measDone();
    void updateGraph(float *,QString, float *);
};
