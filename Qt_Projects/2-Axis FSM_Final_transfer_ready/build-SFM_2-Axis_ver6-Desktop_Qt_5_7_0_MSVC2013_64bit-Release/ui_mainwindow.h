...
public:
    ...
    QPushButton *pushButtonSaveDataCurrent1D;
    QWidget *Result;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_5->setGeometry(QRect(10, 290, 751, 132));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        ...
        pushButtonStart->setGeometry(QRect(210, 30, 120, 100));
        ...
        pushButtonServoStop->setGeometry(QRect(10, 160, 321, 91));
        ...
        widgetOscilloscope->setGeometry(QRect(10, 530, 751, 441));
        ...
        pushButtonServoKill->setGeometry(QRect(220, 20, 150, 130));
        ...
        pushButtonPnaMeasure->setGeometry(QRect(10, 440, 180, 60));
        ...
        layoutWidget4->setGeometry(QRect(40, 530, 120, 24));
        ...
        groupBox_plotyAxisRange->setGeometry(QRect(220, 440, 541, 60));
        ...
        pushButtonSaveDataCurrent1D = new QPushButton(Setting);
        pushButtonSaveDataCurrent1D->setObjectName(QStringLiteral("pushButtonSaveDataCurrent1D"));
        pushButtonSaveDataCurrent1D->setGeometry(QRect(600, 530, 121, 23));
...
#ifndef QT_NO_TOOLTIP
        pushButtonSaveDataCurrent1D->setToolTip(QApplication::translate("MainWindow", "Save the current 1D data in C:\\FSM_Data\\1D_Data.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        pushButtonSaveDataCurrent1D->setStatusTip(QApplication::translate("MainWindow", "Save the current 1D data in C:\\FSM_Data\\1D_Data", 0));
#endif // QT_NO_STATUSTIP
        pushButtonSaveDataCurrent1D->setText(QApplication::translate("MainWindow", "Save Current 1D Data", 0));
