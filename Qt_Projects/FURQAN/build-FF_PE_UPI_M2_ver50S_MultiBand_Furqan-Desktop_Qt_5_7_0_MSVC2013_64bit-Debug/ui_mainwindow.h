...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_1->setGeometry(QRect(11, 10, 1121, 111));
        QFont font1;
        ...
        labelConfigSetting->setGeometry(QRect(470, 30, 401, 81));
        ...
        groupBoxScan->setGeometry(QRect(10, 140, 1261, 81));
        QFont font3;
        font3.setBold(true);
        font3.setWeight(75);
        ...
        layoutWidget1->setGeometry(QRect(0, 20, 1251, 63));
        ...
        labelScanWidth = new QLabel(layoutWidget1);
        labelScanWidth->setObjectName(QStringLiteral("labelScanWidth"));
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(labelScanWidth->sizePolicy().hasHeightForWidth());
        labelScanWidth->setSizePolicy(sizePolicy);
        labelScanWidth->setFont(font);

        horizontalLayout->addWidget(labelScanWidth);
        ...
        horizontalLayout->addWidget(lineEditScanWidth);


        horizontalLayout_30->addLayout(horizontalLayout);
        ...
        lineEditScanHeight = new QLineEdit(layoutWidget1);
        ...
        lineEditScanHeight->setFont(font);
        ...
        lineEditScanHeight->setMaxLength(5);
        ...
        horizontalLayout_30->addLayout(horizontalLayout_4);

        horizontalLayout_7 = new QHBoxLayout();
        horizontalLayout_7->setSpacing(6);
        horizontalLayout_7->setObjectName(QStringLiteral("horizontalLayout_7"));
        labelScanInterval = new QLabel(layoutWidget1);
        labelScanInterval->setObjectName(QStringLiteral("labelScanInterval"));
        sizePolicy.setHeightForWidth(labelScanInterval->sizePolicy().hasHeightForWidth());
        labelScanInterval->setSizePolicy(sizePolicy);
        labelScanInterval->setFont(font);

        horizontalLayout_7->addWidget(labelScanInterval);

        enumScanInterval = new QComboBox(layoutWidget1);
        enumScanInterval->setObjectName(QStringLiteral("enumScanInterval"));
        sizePolicy1.setHeightForWidth(enumScanInterval->sizePolicy().hasHeightForWidth());
        enumScanInterval->setSizePolicy(sizePolicy1);
        enumScanInterval->setFont(font);

        horizontalLayout_7->addWidget(enumScanInterval);


        horizontalLayout_30->addLayout(horizontalLayout_7);
        ...
        horizontalLayout_30->addLayout(horizontalLayout_27);
        ...
        enumPRF = new QComboBox(layoutWidget1);
        enumPRF->setObjectName(QStringLiteral("enumPRF"));
        sizePolicy1.setHeightForWidth(enumPRF->sizePolicy().hasHeightForWidth());
        enumPRF->setSizePolicy(sizePolicy1);
        enumPRF->setMinimumSize(QSize(55, 0));
        enumPRF->setFont(font);

        horizontalLayout_9->addWidget(enumPRF);


        horizontalLayout_30->addLayout(horizontalLayout_9);
        ...
        groupBox_4->setGeometry(QRect(10, 260, 1121, 131));
        ...
        pushButtonJogxp = new QPushButton(layoutWidget2);
        ...
        pushButtonOrigin = new QPushButton(layoutWidget3);
        ...
        pushButtonJogzp = new QPushButton(layoutWidget3);
        ...
        pushButtonJogxn = new QPushButton(layoutWidget4);
        ...
        layoutWidget5->setGeometry(QRect(330, 20, 363, 91));
        ...
        pushButtonGetpos = new QPushButton(layoutWidget5);
        ...
        pushButtonSetpos = new QPushButton(layoutWidget5);
        ...
        lineEditXpos = new QLineEdit(layoutWidget5);
        ...
        lineEditZPos = new QLineEdit(layoutWidget5);
        ...
        lcdNumberZpos = new QLCDNumber(layoutWidget5);
        ...
        lcdNumberXpos = new QLCDNumber(layoutWidget5);
        ...
        pushButtonServoStop->setGeometry(QRect(210, 20, 51, 91));
        pushButtonServoStop->setFont(font3);
        layoutWidget6 = new QWidget(groupBox_4);
        layoutWidget6->setObjectName(QStringLiteral("layoutWidget6"));
        layoutWidget6->setGeometry(QRect(750, 20, 210, 106));
        verticalLayout_30 = new QVBoxLayout(layoutWidget6);
        ...
        pushButtonLaserControl = new QPushButton(layoutWidget6);
        ...
        labelLaserStatus = new QLabel(layoutWidget6);
        ...
        pushButtonLdvAutoFocus = new QPushButton(layoutWidget6);
        ...
        horizontalLayout_5->addWidget(pushButtonLdvAutoFocus);
        ...
        pushButtonLdvAutoFocus_2 = new QPushButton(layoutWidget6);
        ...
        horizontalLayout_6->addWidget(pushButtonLdvAutoFocus_2);
        ...
        verticalLayout_30->addLayout(horizontalLayout_6);

        layoutWidget->raise();
        pushButtonServoStop->raise();
        layoutWidget->raise();
        splitter_7->raise();
        groupBox_2 = new QGroupBox(SettingTab);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        groupBox_2->setGeometry(QRect(10, 420, 219, 70));
        ...
        layoutWidget7->setGeometry(QRect(150, 560, 661, 51));
        horizontalLayout_16 = new QHBoxLayout(layoutWidget7);
        horizontalLayout_16->setSpacing(6);
        horizontalLayout_16->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_16->setObjectName(QStringLiteral("horizontalLayout_16"));
        horizontalLayout_16->setContentsMargins(0, 0, 0, 0);
        pushButtonInit = new QPushButton(layoutWidget7);
        ...
        font6.setBold(true);
        font6.setWeight(75);
        pushButtonInit->setFont(font6);

        horizontalLayout_16->addWidget(pushButtonInit);

        pushButtonDaqSet = new QPushButton(layoutWidget7);
        ...
        pushButtonDaqSet->setFont(font6);

        horizontalLayout_16->addWidget(pushButtonDaqSet);

        pushButtonQuit = new QPushButton(layoutWidget7);
        ...
        labelRefWarning->setFont(font6);
        layoutWidget8 = new QWidget(SettingTab);
        layoutWidget8->setObjectName(QStringLiteral("layoutWidget8"));
        layoutWidget8->setGeometry(QRect(650, 440, 501, 31));
        horizontalLayout_23 = new QHBoxLayout(layoutWidget8);
        ...
        ldvSignalLevel = new QProgressBar(layoutWidget8);
        ...
        checkBoxRealTimeMedian->setGeometry(QRect(150, 620, 501, 17));
        checkBoxRealTimeMedian->setFont(font6);
        checkBoxRealTimeMedian->setChecked(false);
        layoutWidget9 = new QWidget(SettingTab);
        layoutWidget9->setObjectName(QStringLiteral("layoutWidget9"));
        layoutWidget9->setGeometry(QRect(630, 490, 471, 29));
        horizontalLayout_39 = new QHBoxLayout(layoutWidget9);
        ...
        labelScanHeight_2 = new QLabel(layoutWidget9);
        ...
        lineEditDaqVoltage = new QLineEdit(layoutWidget9);
        ...
        pushButtonDaqConfig = new QPushButton(layoutWidget9);
        ...
        layoutWidget10->setGeometry(QRect(900, 630, 211, 29));
        horizontalLayout_25 = new QHBoxLayout(layoutWidget10);
        horizontalLayout_25->setSpacing(6);
        horizontalLayout_25->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_25->setObjectName(QStringLiteral("horizontalLayout_25"));
        horizontalLayout_25->setContentsMargins(0, 0, 0, 0);
        labelScanInterval_4 = new QLabel(layoutWidget10);
        ...
        enumOsciChannel = new QComboBox(layoutWidget10);
        ...
        layoutWidget11 = new QWidget(SettingTab);
        layoutWidget11->setObjectName(QStringLiteral("layoutWidget11"));
        layoutWidget11->setGeometry(QRect(1150, 0, 254, 24));
        horizontalLayout_36 = new QHBoxLayout(layoutWidget11);
        horizontalLayout_36->setSpacing(6);
        horizontalLayout_36->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_36->setObjectName(QStringLiteral("horizontalLayout_36"));
        horizontalLayout_36->setContentsMargins(0, 0, 0, 0);
        labelTrigDelay = new QLabel(layoutWidget11);
        ...
        lineEditDaqTrigDelay = new QLineEdit(layoutWidget11);
        ...
        layoutWidget12 = new QWidget(Subbandtab);
        layoutWidget12->setObjectName(QStringLiteral("layoutWidget12"));
        layoutWidget12->setGeometry(QRect(170, 1, 584, 100));
        verticalLayout_18 = new QVBoxLayout(layoutWidget12);
        ...
        horizontalSliderSubband = new QSlider(layoutWidget12);
        ...
        labelFrameSubband = new QLabel(layoutWidget12);
        ...
        font7.setBold(false);
        font7.setWeight(50);
        labelVtwamRangeTitle->setFont(font7);
        ...
        labelCurrentDataSpec->setFont(font8);
        ...
        layoutWidget13 = new QWidget(ResultTab);
        layoutWidget13->setObjectName(QStringLiteral("layoutWidget13"));
        layoutWidget13->setGeometry(QRect(2, 800, 131, 188));
        verticalLayout_19 = new QVBoxLayout(layoutWidget13);
        verticalLayout_19->setSpacing(6);
        verticalLayout_19->setContentsMargins(11, 11, 11, 11);
        verticalLayout_19->setObjectName(QStringLiteral("verticalLayout_19"));
        verticalLayout_19->setContentsMargins(0, 0, 0, 0);
        groupBox_5 = new QGroupBox(layoutWidget13);
        ...
        groupBox = new QGroupBox(layoutWidget13);
        ...
        verticalLayout_24 = new QVBoxLayout(layoutWidget14);
        ...
        verticalLayout_211 = new QVBoxLayout(layoutWidget15);
        ...
        horizontalLayout_13 = new QHBoxLayout(layoutWidget16);
        ...
        QWidget::setTabOrder(lineEditScanWidth, lineEditScanHeight);
        QWidget::setTabOrder(lineEditScanHeight, enumScanInterval);
        QWidget::setTabOrder(enumScanInterval, enumPRF);
        QWidget::setTabOrder(enumPRF, enumCurrent);
        ...
        QWidget::setTabOrder(pushButtonGetpos, pushButtonLaserControl);
        QWidget::setTabOrder(pushButtonLaserControl, pushButtonLdvAutoFocus);
        QWidget::setTabOrder(pushButtonLdvAutoFocus, pushButtonLdvAutoFocus_2);
        QWidget::setTabOrder(pushButtonLdvAutoFocus_2, enumPlaySpeed);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelScanWidth->setText(QApplication::translate("MainWindow", "Width(mm):", 0));
...
#endif // QT_NO_STATUSTIP
        labelScanHeight->setText(QApplication::translate("MainWindow", "Height(mm):", 0));
#ifndef QT_NO_TOOLTIP
        lineEditScanHeight->setToolTip(QApplication::translate("MainWindow", "Valid range: 50mm~700mm - Increment: 10mm", 0));
#endif // QT_NO_TOOLTIP
        labelScanInterval->setText(QApplication::translate("MainWindow", "Interval(mm):", 0));
#ifndef QT_NO_TOOLTIP
        ...
        label_16->setText(QApplication::translate("MainWindow", "PRR(Hz):", 0));
