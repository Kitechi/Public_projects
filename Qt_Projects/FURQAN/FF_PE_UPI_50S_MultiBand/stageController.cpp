...
*/
    ...
    //acc time:K150 mini stage
       if (speed == 100 && scanInfoPtr->enableTT == false)      offset = 3075; //2550 //2870
       if (speed == 50 && scanInfoPtr->enableTT == false)      offset = 510;
       if (speed == 250 && scanInfoPtr->enableTT == false)      offset = 7325; //7325 big //tt configuration: 250 mm/s -> offset: 6250   //7475
       if (speed == 250 && scanInfoPtr->enableTT == true)      offset = 2500;//2650suhyun //7325 big //tt configuration: 250 mm/s -> offset: 6250   //7475
       if (speed == 150 && scanInfoPtr->enableTT == false)      offset = 1200;
       if (speed == 150 && scanInfoPtr->enableTT == true)      offset = 4500; //3500
       if (speed == 350 && scanInfoPtr->enableTT == false)      offset = 2000;
       if (speed == 400 && scanInfoPtr->enableTT == true)      offset = 3500; // 2500->3000->2750->3500
       if (speed == 100 && scanInfoPtr->enableTT == true)      offset = 1000; //1000 soohyun  //tt configuration: 250 mm/s -> offset: 6250 //1550 //1120
       if (speed ==  75 && scanInfoPtr->enableTT == true)      offset = 2550;  //tt configuration: 250 mm/s -> offset: 6250
       if (speed ==  50 && scanInfoPtr->enableTT == true)      offset = 510;  //tt configuration: 250 mm/s -> offset: 6250
       if (speed ==  20 && scanInfoPtr->enableTT == true)      offset = 219;
