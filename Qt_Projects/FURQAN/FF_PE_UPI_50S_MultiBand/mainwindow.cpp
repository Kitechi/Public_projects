...
void MainWindow::setSettingStruct()
{
    ...
    settingArr[4].filtPar[1].hiPassCut   = 1504;
    settingArr[4].filtPar[1].lowPassCut  = 2000;
    settingArr[4].filtPar[1].gain        = 22;

    //5-SingleChan-0
    settingArr[5].ldvRange              = 25;
    settingArr[5].samplingFreq          = 20;
    settingArr[5].chNum                 = 1;
    settingArr[5].trigDelay             = 288; //300 SooHyun//400 SY // 300 // 240
    settingArr[5].daqVoltage            = 500; // 200 SY
    ...
    settingArr[6].trigDelay             = 640; // 800 SY // initial : 576,
    settingArr[6].daqVoltage            = 500; //200 SY
    ...
    settingArr[7].trigDelay             = 500; //500 SUHYUN
    settingArr[7].daqVoltage            = 500; //500 SUHYUN

    settingArr[7].filtPar[1].hiPassCut   = 500;
    settingArr[7].filtPar[1].lowPassCut  = 750;
    settingArr[7].filtPar[1].gain        = 18; //18 SUHYUN

    //8-SingleChan-3
    settingArr[8].ldvRange              = 20; //50 SUHYUN
    settingArr[8].samplingFreq          = 60;
    settingArr[8].chNum                 = 1;
    settingArr[8].trigDelay             = 535; //550 Scan 1
    settingArr[8].daqVoltage            = 200; //1000 Scan 1 //500 for pt M and H //2000 for Scan2

    settingArr[8].filtPar[1].hiPassCut   = 750;
    settingArr[8].filtPar[1].lowPassCut  = 1000;
    settingArr[8].filtPar[1].gain        = 18; //18 SUHYUN

    //9-SingleChan-4
    settingArr[9].ldvRange               = 50;
    settingArr[9].samplingFreq           = 60;
    settingArr[9].chNum                  = 1;
    settingArr[9].trigDelay             = 520;
    settingArr[9].daqVoltage            = 200;

    settingArr[9].filtPar[1].hiPassCut   = 1000;
    settingArr[9].filtPar[1].lowPassCut  = 1166;
    settingArr[9].filtPar[1].gain        = 18;

    //10-SingleChan-5
    settingArr[10].ldvRange               = 20;
    settingArr[10].samplingFreq           = 20;
    ...
    settingArr[11].trigDelay             = 600;
    settingArr[11].daqVoltage            = 200;

    settingArr[11].filtPar[1].hiPassCut   = 1000; //1332
    settingArr[11].filtPar[1].lowPassCut  = 1500;
    settingArr[11].filtPar[1].gain        = 25;


    // Update - Testing - FURQAN

    //12-SingleChan-7
    settingArr[12].ldvRange              = 50;
    settingArr[12].samplingFreq          = 60;
    settingArr[12].chNum                 = 1;
    settingArr[12].trigDelay             = 510; //510 Furqan
    settingArr[12].daqVoltage            = 200; //500

    settingArr[12].filtPar[1].hiPassCut   = 1000;
    settingArr[12].filtPar[1].lowPassCut  = 1500;
    settingArr[12].filtPar[1].gain        = 25; //18


    //13-SingleChan-8
    settingArr[13].ldvRange              = 200;
    settingArr[13].samplingFreq          = 60;
    settingArr[13].chNum                 = 1;
    settingArr[13].trigDelay             = 240;//240 for 1.5-2.0 MHz
    settingArr[13].daqVoltage            = 200;//200

    settingArr[13].filtPar[1].hiPassCut   = 1500;
    settingArr[13].filtPar[1].lowPassCut  = 2000;
    settingArr[13].filtPar[1].gain        = 25;

    //14-SingleChan-9
    settingArr[14].ldvRange              = 200;
    settingArr[14].samplingFreq          = 60;
    settingArr[14].chNum                 = 1;
    settingArr[14].trigDelay             = 160;//230 for Scan 1

    settingArr[14].daqVoltage            = 200;//200 for Scan 1

    settingArr[14].filtPar[1].hiPassCut   = 2000;
    settingArr[14].filtPar[1].lowPassCut  = 2500;
    settingArr[14].filtPar[1].gain        = 25;//25 for Scan 1
...
void MainWindow::deviceConnect()
{
    ...
    laser->srchPortandConnect("COM23",&laserComPort);
    ldv->connectLdv("COM3");

    return;

#if 0
    if (laser->srchPortandConnect("COM23",&laserComPort) == true)
    {
        /*
    ...
    if(enteredPar >= 5)
    {
        if(enteredPar <= maxScanRangemm)
        {
            if (enteredPar%5 == 0)
                ...
                validPar = (5-enteredPar%5) +  enteredPar;
        }
        else
...
void MainWindow::on_checkBoxEnableMultiBand_toggled(bool checked)
{
    ...
    else
    {
        ...
        ui->enumMultiBandSettingLev1->addItem("1000-1500 kHz");
         ui->enumMultiBandSettingLev1->addItem("1500-2000 kHz");
         ui->enumMultiBandSettingLev1->addItem("2000-2500 kHz");
