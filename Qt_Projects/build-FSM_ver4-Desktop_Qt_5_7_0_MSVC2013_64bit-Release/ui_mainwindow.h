...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_5->setGeometry(QRect(-10, 230, 801, 132));
        QFont font1;
        font1.setBold(true);
        font1.setWeight(75);
        ...
        groupBoxScan->setGeometry(QRect(0, 10, 791, 71));
        ...
        groupBox_1->setGeometry(QRect(790, 20, 791, 71));
        QFont font4;
        ...
        groupBox_4->setGeometry(QRect(0, 90, 791, 131));
        ...
        pushButtonJogyn->setEnabled(false);
        QFont font5;
        ...
        widgettResultSpect->setGeometry(QRect(-2, 0, 1750, 671));
